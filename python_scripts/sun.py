...
class Sun:
    ...
    def __init__(self):
        self.utcTime=self.getCurrentUTC()

        #1. first calculate the day of the year
        day, month, year = self.utcTime
    ...
    def calcSunTime( self, coords, isRiseTime, zenith = 90.8 ):
        ...
        if cosH > 1:
            return {'status': False, 'alwaysDay': False, 'alwaysNight': True , 'msg': 'the sun never rises on this location (on the specified date)'}

        if cosH < -1:
            return {'status': False, 'alwaysDay': True, 'alwaysNight': False, 'msg': 'the sun never sets on this location (on the specified date)'}
